...
public class GraphicsDisplay extends JPanel {
    ...
    protected void paintMarkers(Graphics2D canvas) {
        // Установка более толстого штриха
        ...
        for (double[] point : graphicsData) {
            ...
            // Длина линий
            int lineLength = 7;
            int smallLineLength = 2; // Длина маленьких палочек

            // Рисуем горизонтальную линию
            canvas.drawLine(centerX - lineLength, centerY, centerX + lineLength, centerY);
            // Рисуем вертикальную линию
            canvas.drawLine(centerX, centerY - lineLength, centerX, centerY + lineLength);

            // Рисуем маленькие палочки на концах горизонтальной линии
            canvas.drawLine(centerX - lineLength, centerY - smallLineLength, centerX - lineLength, centerY + smallLineLength);
            canvas.drawLine(centerX + lineLength, centerY - smallLineLength, centerX + lineLength, centerY + smallLineLength);

            // Рисуем маленькие палочки на концах вертикальной линии
            canvas.drawLine(centerX - smallLineLength, centerY - lineLength, centerX + smallLineLength, centerY - lineLength);
            canvas.drawLine(centerX - smallLineLength, centerY + lineLength, centerX + smallLineLength, centerY + lineLength);
        }
    }
    ...
    private boolean isAscending(double[] point) {
        ...
        return isPerfectSquare(wholePartY); // Проверяем, является ли целая часть квадратом целого числа
    }
